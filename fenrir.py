...
def configure_options(argv) -> dict:
    ...
    options = {'host':'', 'login':'', 'login_wordlist':'', 'password':'', 'password_wordlist':'', 'data':'', 'tor_connection':False, 'text_error':'', 'status_error':'', 'success_text':'', 'success_status':'', 'threads':15, 'cookies':'', 'verbose':False, 'random_user_agents':False}
